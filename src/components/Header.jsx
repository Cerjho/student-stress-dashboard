  ...
  return (
    <header className="bg-gradient-to-r from-blue-600 to-blue-800 text-white shadow-lg">
      <div className="container mx-auto px-6 py-6">
        <div className="mb-4">
          <h1 className="text-2xl md:text-3xl font-bold">Student Stress Analysis Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {metrics.map(({ key, label, icon: Icon, gradient }) => (
            <div
              key={key}
              className={`bg-gradient-to-br ${gradient} text-white rounded-lg p-6 shadow-md flex items-center justify-between`}
            >
              <div>
